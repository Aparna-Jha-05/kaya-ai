...
export default function Card({
  ...
  return (
    <div
      className={`rounded-2xl border border-line border-b-2 bg-card shadow-xs transition duration-150 hover:border-cyan/40 max-w-full relative overflow-visible ${className}`}
