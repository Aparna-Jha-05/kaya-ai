...
export default function Legend() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-50">
      {open ? (
        <div className="w-56 rounded-xl border border-white/15 bg-card/95 p-3 shadow-2xl backdrop-blur">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-full border border-white/15 bg-card/95 px-3 py-2 text-xs text-text/70 shadow-xl backdrop-blur hover:text-text"
        >
