...
export default function Tooltip({
  ...
  return (
    ...
    >
      {label}
      {open && body && (
        <span className="absolute bottom-full left-1/2 z-50 mb-2 w-60 -translate-x-1/2 rounded-lg border border-white/15 bg-surface px-3 py-2 text-left text-xs font-normal leading-relaxed text-text/80 shadow-xl">
