    ...
    <Card>
      <CardHeader
        title={
          <span className="flex items-center gap-2">
            The Docket · <Tooltip term="TCO²">5-Year TCO²</Tooltip> Ranking
          </span>
        }
        caption="All three vendors, priced across every dimension. The cheapest sticker price is not the cheapest bid."
      />
      ...
      <div className="mx-4 mb-4 flex items-start gap-2.5 rounded-lg border border-amber/25 bg-amber/5 px-4 py-3">
        ...
        <p className="text-sm text-text/85">
          The cheapest bid is the most expensive once carbon, reliability, and
          schedule are priced in.{" "}
