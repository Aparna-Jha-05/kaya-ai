  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-text/55">Compare cost, compliance checks, vendor reliability, and schedule impact. Open a bid to inspect the supporting evidence.</p>
      </div>
